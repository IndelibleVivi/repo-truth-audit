...
The new intent reference joins the explicit nine-file Skill payload. Source
...
standalone public docs and diagrams use CC BY-NC-SA 4.0 under [LICENSING.md](../LICENSING.md).
